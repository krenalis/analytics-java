...
import com.krenalis.analytics.gson.AutoValueAdapterFactory;
import com.krenalis.analytics.gson.ISO8601DateAdapter;
import com.krenalis.analytics.http.KrenalisService;
import com.krenalis.analytics.internal.AnalyticsClient;
import com.krenalis.analytics.internal.AnalyticsVersion;
...
/**
 * The entry point into the Krenalis for Java library.
 *
 * <p>The idea is simple: one pipeline for all your data. Krenalis is the single hub to collect,
 * translate and route your data with the flip of a switch.
 *
 * <p>Analytics for Java will automatically batch events and upload it periodically to Krenalis's
 * servers for you. You only need to instrument Krenalis once, then flip a switch to install new
 * tools.
 *
...
public class Analytics {
   ...
   *
   * @param writeKey Your project write key available on the Krenalis dashboard.
   */
  public static Builder builder(String writeKey) {
    return new Builder(writeKey);
  }

  /** Enqueue the given message to be uploaded to Krenalis's servers. */
  ...
  public static class Builder {
    ...
    public Analytics build() {
      ...
      KrenalisService krenalisService = restAdapter.create(KrenalisService.class);
